...
class Application(object):
    ...
    Welcome to the ConAudio Application!
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~

    This class is the backbone of the ConAudio application: it knows
    ...
    def __init__(self, settings_path='conaudio.settings', *args, **kwargs):
        self.assets = None
    ...
    def from_env(CreateApplication,
                 environment_variable_name='CONAUDIO_SETTINGS_MODULE',
                 fallback_module_name='conaudio.settings',
                 *flask_args,
                 **flask_kwargs):
