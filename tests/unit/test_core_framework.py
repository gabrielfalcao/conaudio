...
from conaudio.framework.core import Application, ErrorHandlers


@patch('conaudio.framework.core.Flask')
def test_application_has_flask_app(Flask):
    ...
    Flask.assert_called_once_with('conaudio.framework.core')
...
@patch('conaudio.framework.core.ErrorHandlers')
@patch('conaudio.framework.core.Flask')
...
@patch('conaudio.framework.core.RedisSessionInterface')
@patch('conaudio.framework.core.Flask')
...
@patch('conaudio.framework.core.AssetsManager')
@patch('conaudio.framework.core.Flask')
...
@patch('conaudio.framework.core.Manager')
@patch('conaudio.framework.core.Flask')
...
@patch('conaudio.framework.core.log')
@patch('conaudio.framework.core.Flask')
...
@patch('conaudio.framework.core.os')
@patch('conaudio.framework.core.RedisSessionInterface')
@patch('conaudio.framework.core.Flask')
...
@patch('conaudio.framework.core.render_template')
