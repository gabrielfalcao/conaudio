...
from conaudio.framework.formats.json import json_converter, loads, dumps
...
@patch('conaudio.framework.formats.json.json')
...
@patch('conaudio.framework.formats.json.json')
@patch('conaudio.framework.formats.json.json_converter')
