...
from conaudio.framework.log import (
    ColorFormatter,
...
@patch('conaudio.framework.log.settings')
@patch('conaudio.framework.log.logging')
...
@patch('conaudio.framework.log.settings')
@patch('conaudio.framework.log.logging')
@patch('conaudio.framework.log.ColorFormatter')
...
@patch('conaudio.framework.log.logging')
@patch('conaudio.framework.log.datetime')
