...
from conaudio.framework.handy.functions import (
    slugify,
    empty,
    now,
    geo_data_for_ip,
...
@patch('conaudio.framework.handy.functions.datetime')
...
@patch('conaudio.framework.handy.functions.request')
...
@patch('conaudio.framework.handy.functions.PyGEOIP')
