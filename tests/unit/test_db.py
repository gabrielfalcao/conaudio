...
from conaudio.framework.db import (
    Model,
    Manager,
...
@patch('conaudio.framework.db.partial')
...
@patch('conaudio.framework.db.StrictRedis')
...
@patch('conaudio.framework.db.engine')
...
@patch('conaudio.framework.db.db.Column')
@patch('conaudio.framework.db.db.Integer')
@patch('conaudio.framework.db.db.ForeignKey')
