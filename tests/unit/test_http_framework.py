...
@patch('conaudio.framework.http.settings')
...
@patch('conaudio.framework.http.json_response')
...
@patch('conaudio.framework.http.set_cors_into_headers')
@patch('conaudio.framework.http.Response')
@patch('conaudio.framework.http.json')
...
@patch('conaudio.framework.http.request')
@patch('conaudio.framework.http.traceback')
@patch('conaudio.framework.http.logger')
