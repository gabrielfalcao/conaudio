...
from conaudio.server import application
from conaudio.framework.db import metadata, engine, Model, get_redis_connection
...
def api_specification(role_name, email='foo@bar.com', password='123'):
    ...
    def prepare_token(context):
        ...
        context.headers = {'X-ConAudio-Token': context.token}
